...
function start() {
  ...
  window.scrollTo(0, 1); // Attach the video stream to the video element and autoplay.
...
function onResize() {
  container.style.height = "".concat(window.innerHeight, "px");
...
//# sourceMappingURL=/id-photo.e31bb0bc.js.map